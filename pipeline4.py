...
if __name__ == "__main__":
    ...
    pipeline.run(
        ...
        # reuse_single_sam3d_ply="./output_pipeline4/01_sam3d_single/sam3d_single_clean.ply",
        reuse_single_sam3d_ply=None,

        # 第一次完整运行：None
        # 如果你已经有 joint SAM3D，可以填：
        # reuse_joint_ply="./output_pipeline4/05_joint_sam3d/sam3d_object_table_joint_clean.ply",
        reuse_joint_ply=None,
